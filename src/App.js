        ...
        <div className="App">
            ...
            <div className="block5 uk-container container">
                ...
                <div className="col-12 mt-5 example">
                    ...
                    <div className="col-md-8 col-lg-8 col-sm-12 work-students uk-child-width-1-1" uk-grid=""
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/anatoliy-zakharov-final-renders-1.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 12">
                                    <img src="./source/slider/anatoliy-zakharov-final-renders-1.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/anatoliy-zakharov-gas-stove-01-camera-1-001.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 13">
                                    <img src="./source/slider/anatoliy-zakharov-gas-stove-01-camera-1-001.jpg"
                                         width="1800" height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/anatoliy-zakharov-gas-stove-01-camera-2-001.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 14">
                                    <img src="./source/slider/anatoliy-zakharov-gas-stove-01-camera-2-001.jpg"
                                         width="1800" height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/anton-usov-screenshot004.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 15">
                                    <img src="./source/slider/anton-usov-screenshot004.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/artsiom-paltaratski-ewwwe-main-camera-01.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 16">
                                    <img src="./source/slider/artsiom-paltaratski-ewwwe-main-camera-01.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/artsiom-paltaratski-hause-foto-main-camera-02.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 17">
                                    <img src="./source/slider/artsiom-paltaratski-hause-foto-main-camera-02.jpg"
                                         width="1800" height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/artsiom-paltaratski-rty003.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 18">
                                    <img src="./source/slider/artsiom-paltaratski-rty003.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/elena-pogrebnaya-6rr.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 19">
                                    <img src="./source/slider/elena-pogrebnaya-6rr.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/elena-pogrebnaya-10rr.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 20">
                                    <img src="./source/slider/elena-pogrebnaya-10rr.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/elena-pogrebnaya-24rr.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 21">
                                    <img src="./source/slider/elena-pogrebnaya-24rr.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/evgeny-gapeev-3.jpg"
                                   style={{overflow: 'hidden'}}
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/evgeny-gapeev-11.jpg"
                                   style={{overflow: 'hidden'}}
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/evgeny-gapeev-testnight-screen7.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 24">
                                    <img src="./source/slider/evgeny-gapeev-testnight-screen7.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-gifius-ru-1.gif"
                                   style={{overflow: 'hidden'}}
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-highresscreenshot00000-min.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 26">
                                    <img src="./source/slider/-highresscreenshot00000-min.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-highresscreenshot00002.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 27">
                                    <img src="./source/slider/-highresscreenshot00002.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-highresscreenshot00004-min.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 28">
                                    <img src="./source/slider/-highresscreenshot00004-min.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-highresscreenshot00009.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 29">
                                    <img src="./source/slider/-highresscreenshot00009.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/ilya-michajlov-highresscreenshot00006.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 30">
                                    <img src="./source/slider/ilya-michajlov-highresscreenshot00006.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/ilya-michajlov-screen.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 31">
                                    <img src="./source/slider/ilya-michajlov-screen.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/ivan-mankevich-banner-low-lambert1-basecolor1.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 32">
                                    <img src="./source/slider/ivan-mankevich-banner-low-lambert1-basecolor1.jpg"
                                         width="1800" height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline"
                                   href="./source/slider/ivan-mankevich-highresscreenshot00002.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 33">
                                    <img src="./source/slider/ivan-mankevich-highresscreenshot00002.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/julia-golikova-b12-main-camera-0-002.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 34">
                                    <img src="./source/slider/julia-golikova-b12-main-camera-0-002.jpg" width="1800"
                                         height="1200" alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/marat-02.jpg"
                                   style={{overflow: 'hidden'}}
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/marat-renders4.jpg"
                                   style={{overflow: 'hidden'}}
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/marina-bich-screenshot005.jpg"
                                   style={{overflow: 'hidden'}}
                                   data-caption="Example 37">
                                    <img src="./source/slider/marina-bich-screenshot005.jpg" width="1800" height="1200"
                                         alt=""
                                         style={{width: '100%', height: '100%', objectFit: 'cover'}}/>>
                                </a>
                            </div>
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-nerminator-2.jpg"
                                   style={{overflow: 'hidden'}}
                        ...
                        <div className="uk-child-width-1-1 hide" uk-grid="">
                            <div className="uk-width-1-1 uk-height-small">
                                <a className="uk-inline" href="./source/slider/-screenshot004.jpg"
                                   style={{overflow: 'hidden'}}
                ...
                <div className="row mt-5 footer">
                    ...
                    <div className="discount m-auto col-lg-8 col-md-12 col-sm-12">
                        <div className="border-around">
                            <div className="text">
                                <p>После прохождения этого курса ты получишь 50% скидку на курсы :</p>
                ...
                <div className="row mt-5">
                    <div className="discount m-auto col-lg-10 col-md-12 col-sm-12">
                        <div className="border-around">
                            <div className="text">
                                <p><b>Цена курса:</b></p>
                                <p className="mb-2"><b>6</b> месяцев <b>500$</b></p>
                                ...
                                <div className="order-contacts">
                                    ...
                                    <div className='return-soc'>
                                        ...
                                        <div className="social">
                                            ...
                                            <a href="https://t.me/Education_3D_ART" target="_blank"
                                               rel="nofollow noopener">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
