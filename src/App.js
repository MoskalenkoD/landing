                    ...
                    <div className="uk-child-width-1-2" uk-grid="" uk-lightbox="animation: slide">
                        ...
                        <div>
                            <div className="uk-child-width-1-2" uk-grid="">
                                ...
                                <div>
                                    <div className="uk-width-1-1 uk-height-small p-3">
                                        <a className="uk-inline" href="./source/slider/551.jpg" style={{overflow: 'hidden', width: '100%', height: '100%'}}
                            ...
                            <div className="uk-child-width-1-1" uk-grid="">
                                <div className="uk-width-1-1 uk-height-small p-3">
                                    <a className="uk-inline" href="./source/slider/660.jpg" style={{overflow: 'hidden', height: '100%'}}
                            ...
                            <div className="uk-child-width-1-2" uk-grid="">
                                <div className="uk-first-column">
                                    <div className="uk-width-1-1 uk-height-medium p-3">
                                        <a className="uk-inline" href="./source/slider/221.jpg" style={{overflow: 'hidden', height: '100%'}}
